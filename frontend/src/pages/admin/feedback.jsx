          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-bold text-gray-900">{stats.urgent + stats.high}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-bold text-gray-900">{stats.resolved}</dd>
              </dl>
            </div>
          </div>
        </div>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center"
                >
                  {submittingResponse ? (
                    <>
