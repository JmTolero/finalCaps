...
const emailTemplates = {
  vendorApproved: (vendorData) => ({
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p><strong>Important:</strong> To start receiving payments, please complete your GCash number setup in your vendor dashboard under Settings → GCash Number Setup. Enter your GCash mobile number to enable integrated payment processing. This is required before you can manage products and receive customer payments.</p>
    ...
    text: `
      ...
      IMPORTANT: To start receiving payments, please complete your GCash number setup in your vendor dashboard under Settings → GCash Number Setup. Enter your GCash mobile number to enable integrated payment processing. This is required before you can manage products and receive customer payments.
