...
export const LandingPage = () => {
    return (
       ...
       <div className="scroll-smooth bg-gradient-to-br from-sky-200 to-blue-400">
        ...
        <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-6 md:px-12 ">
            <div className="flex-1 flex flex-col items-start space-y-4 text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-bold">
                <span className="text-pink-500 italic">Chill</span><span className="text-gray-700">Net</span>
            </h1>
            <h2 className="text-xl md:text-3xl font-semibold italic text-white drop-shadow">Chill. Order. Enjoy!</h2>
            <p className="text-sm md:text-md text-sky-100 italic font-medium">The easiest way to order and sell dirty ice cream online!</p>
            <div className="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-3 sm:space-y-0 mt-4 w-full sm:w-auto">
                ...
                Book now
                <img src="/images/arrow.png" alt="toArrow" className="GoArrow" />
                </Link>
                <a href="vendor-registration.html" className="text-yellow-100 font-semibold hover:underline transition">Become a Vendor</a>
            </div>
            </div>

            <div className="flex-1 flex justify-center mt-8 md:mt-1">
             <img src="/images/piclogo.png" alt="ChillNet Ice Cream" className="rounded-2xl shadow-2xl w-[90%] max-w-md object-cover" />
            </div>
        </section>

    {/* <!-- Drum Cards Section --> */}
    <h1 className="text-3xl md:text-5xl font-extrabold text-center mb-10 selectDrum">You Can Select a Different Drum Sizes</h1>
    <section id="drums" className="flex flex-col md:flex-row justify-center items-center gap-12 mt-24 mb-20 px-6">
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center w-full max-w-xs">
            <div className="bg-gray-300 w-full h-64 rounded mb-6"></div>
            <h3 className="text-2xl font-bold mb-6">Medium Drum</h3>
            <button className="bg-[#ffddae] text-gray-800 font-semibold px-6 py-2 rounded shadow w-full">Schedule now</button>
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center w-full max-w-xs">
            <div className="bg-gray-300 w-full h-64 rounded mb-6"></div>
            <h3 className="text-2xl font-bold mb-6">Large Drum</h3>
            <button className="bg-[#ffddae] text-gray-800 font-semibold px-6 py-2 rounded shadow w-full">Schedule now</button>
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center w-full max-w-xs">
            <div className="bg-gray-300 w-full h-64 rounded mb-6"></div>
            <h3 className="text-2xl font-bold mb-6">Small Drum</h3>
            <button className="bg-[#ffddae] text-gray-800 font-semibold px-6 py-2 rounded shadow w-full">Schedule now</button>
            </div>
        </section>
        ...
        <section className="mt-24 mb-24 px-6">
            ...
            <div className="bg-sky-100 rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-center gap-12 max-w-7xl mx-auto">
            <div className="flex-1 w-full flex flex-col space-y-4">
                <input type="text" placeholder="See Vendors near your Location" className="w-full px-6 py-3 rounded-full bg-white text-gray-700 italic placeholder-gray-400 outline-none" />
                <button className="bg-[#ffddae] text-gray-800 font-semibold px-6 py-2 rounded shadow w-full sm:w-48">Locate Vendors</button>
            </div>
            <div className="flex-1 flex justify-center">
                <div className="bg-gray-600 rounded-2xl p-4">
                <img  alt="Map" className="w-[300px] md:w-[400px] h-[300px] md:h-[350px] object-cover rounded-xl" />
                </div>
            </div>
            </div>
    </section>
