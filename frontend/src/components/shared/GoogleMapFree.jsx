...
const GoogleMapFree = ({ 
  ...
  return (
    <>
      ...
      <div className="absolute top-16 right-4 bg-red-100 border border-red-400 text-red-700 px-3 py-2 rounded text-sm z-20">
        <div className="flex items-center gap-2">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <p className="text-xs">Enable billing & authorize localhost:3000 in Google Cloud Console</p>
          </div>
        </div>
      </div>
    </div>
