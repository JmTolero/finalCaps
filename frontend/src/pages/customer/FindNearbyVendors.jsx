...
export const FindNearbyVendors = () => {
  ...
  return (
    <>
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 py-6 mt-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  ...
                  className="w-64 px-4 py-2 pl-10 pr-4 text-gray-700 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            ...
            <div className="flex items-center space-x-4">
              {/* Page Title */}
              <div className="text-blue-700 font-semibold text-lg relative">
                Find nearby Vendors
              ...
              <button className="p-2 rounded-full hover:bg-gray-100 transition-colors relative">
                ...
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold">3</span>
              </button>
              <button className="p-2 rounded-full hover:bg-gray-100 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-orange-500 mb-6">Find nearby Vendors</h2>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="text-xl font-bold text-gray-800">{vendor.store_name}</h3>
                          <div className="flex items-center space-x-1">
                            <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                            <span className="text-sm text-gray-600">4.5 (55 reviews)</span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 mb-3">
                          ...
                          <span className="text-sm text-gray-600">{vendor.location || 'Cordova, Cebu, Philippines'}</span>
                        </div>

                        {/* Drum Sizes */}
                        <div className="mb-3">
                          <h4 className="text-sm font-semibold text-gray-700 mb-1">Available Drum Sizes:</h4>
                          <div className="flex space-x-2">
                            <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded">Large</span>
                            <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded">Medium</span>
                            <span className="px-2 py-1 bg-purple-100 text-purple-800 text-xs rounded">Small</span>
                          </div>
                        </div>

                        {/* Flavors */}
                        <div className="mb-3">
                          <h4 className="text-sm font-semibold text-gray-700 mb-1">Flavors:</h4>
                          <div className="flex flex-wrap gap-1">
                            {vendor.flavors && vendor.flavors.length > 0 ? (
                              vendor.flavors.slice(0, 3).map((flavor, index) => (
                              ...
                              <>
                                <span className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded">Mango</span>
                                <span className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded">Ube</span>
                                <span className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded">Choco</span>
                              </>
                            )}
                          </div>
                        </div>
          ...
          <div className="bg-gray-100 rounded-lg overflow-hidden">
            <div className="h-96 bg-gray-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">Map will show vendor locations with markers</p>
                <p className="text-sm text-gray-400 mt-2">Cordova, Cebu, Philippines</p>
              </div>
            </div>
          </div>
        </div>
