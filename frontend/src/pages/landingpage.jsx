...
export const LandingPage = () => {
    return (
        ...
        <div class="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-3 sm:space-y-0 mt-4 w-full sm:w-auto">
            <a href="customer-login.html" class="bg-[#ffddae] text-black font-semibold px-8 py-3 rounded-full border border-gray-400 shadow flex items-center justify-center transition hover:bg-[#ffe7c4] w-full sm:w-auto">
            Book now
        ...
        <img src="https://i.ibb.co/6bQ7QwP/chillnet-logo.png" alt="ChillNet Ice Cream" class="rounded-2xl shadow-2xl w-[90%] max-w-md object-cover" />
        </div>
    </section>
    ...
    <section class="mt-24 mb-24 px-6">
        <h2 class="text-3xl md:text-5xl font-extrabold text-center mb-12">FIND NEARBY VENDORS</h2>
        ...
        <div class="flex-1 flex justify-center">
            ...
            <img src="https://i.ibb.co/6bQ7QwP/map-sample.png" alt="Map" class="w-[300px] md:w-[400px] h-[300px] md:h-[350px] object-cover rounded-xl" />
            </div>
        </div>
        </div>
    </section>
    ...
    {/* <!-- How It Works --> */}
    <section class="relative mt-24 mb-24 px-6 min-h-[700px] flex flex-col items-center justify-center">
        <h3 class="text-3xl md:text-5xl font-extrabold text-center mb-12 z-10">How It Works</h3>
